...
import com.example.appadmin.adapter.ChatAdapter;
import com.example.appadmin.databinding.ActivityChatBinding;
import com.example.appadmin.model.ChatMessage;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void listenMess(){
        db.collection(Ultils.PATH_CHAT)
                ...
                .whereEqualTo(Ultils.RECEIVEID, str_iduser)
    ...
    private void sendMessToFirebase() {
        ...
        if (str_mess.isEmpty()){
            ...
            message.put(Ultils.RECEIVEID, str_iduser);
